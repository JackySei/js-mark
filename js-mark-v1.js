(function (global, factory) {
  ...
  var reserved_words = line_starters$1.concat([
    "do",
    "in",
    "of",
    "else",
  ...
  var Tokenizer$3 = function (input_string, options) {
    ...
    var templatable = new TemplatablePattern$1(this._input).read_options(
      this._options
    );
    ...
    if (raw_token.text !== "") {
      ...
      if (
        ...
        _beautifier = function (html_source, options) {
          var beautifier = new Beautifier$1(
            html_source,
            options,
            local._js_beautify,
            local._css_beautify
    ...
    _captureSelection(range) {
      ...
      if (
        ...
        return this._onError(
          "不允许覆盖标注，详细请看配置文档，或设置isCover为true"
        );
      }
